Locales['fi'] = {
  ...
  ['license_revoked'] = 'sinun ~g~%s~s~ ~y~kumottiin~s~!',
  ['licence_you_revoked'] = 'sinä kumosit ~g~%s~s~ mikä kuului henkilölle ~y~%s~s~',
  ['no_players_nearby'] = 'ei pelaajia lähettyvillä',
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~g~Police~s~',
  -- Vehicle interaction
  ...
  ['search_database_found'] = 'ajoneuvo on ~y~rekistöröity~s~ henkilölle ~g~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'sinä takavarioit ~y~%sx~s~ ~g~%s~s~ pelaajalta ~g~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~g~%s~s~ takavarikoitiin sinulta pelaajan ~y~%s~s~ toimesta',
  ['you_confiscated_account'] = 'sinä takavarikoit ~g~$%s~s~ (%s) pelaajalta ~g~%s~s~',
  ['got_confiscated_account'] = '~g~$%s~s~ (%s) takavarikoitiin sinulta pelaajan ~y~%s~s~ toimesta',
  ['you_confiscated_weapon'] = 'sinä takavarikoit ~g~%s~s~ pelaajalta ~g~%s~s~ jossa oli ~o~%s~s~ panosta',
  ['got_confiscated_weapon'] = 'sinun ~g~%s~s~ jossa oli ~o~%s~s~ panosta takavarikoitiin sinulta~y~%s~s~',
  ...
  ['have_withdrawn'] = 'sinä otit varastosta ~y~%sx~s~ ~g~%s~s~',
  ['have_deposited'] = 'sinä talletit varastoon ~y~%sx~s~ ~g~%s~s~',
  ['quantity'] = 'määrä',
  ['inventory'] = 'varasto',
