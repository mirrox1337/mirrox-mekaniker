Locales['br'] = {
  ...
  ['license_revoked'] = 'your ~g~%s~s~ has been ~y~revoked~s~!',
  ['licence_you_revoked'] = 'you revoked a ~g~%s~s~ which belonged to ~y~%s~s~',
  ...
  ['search_database_found'] = 'o veículo está ~y~registrado~s~ para ~g~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'you confiscated ~y~%sx~s~ ~g~%s~s~ from ~g~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~g~%s~s~ were confiscated by ~y~%s~s~',
  ['you_confiscated_account'] = 'you confiscated ~g~$%s~s~ (%s) from ~g~%s~s~',
  ['got_confiscated_account'] = '~g~$%s~s~ (%s) was confiscated by ~y~%s~s~',
  ['you_confiscated_weapon'] = 'you confiscated ~g~%s~s~ from ~g~%s~s~ with ~o~%s~s~ bullets',
  ['got_confiscated_weapon'] = 'your ~g~%s~s~ with ~o~%s~s~ bullets was confiscated by ~y~%s~s~',
  ...
  ['have_withdrawn'] = 'you have withdrawn ~y~%sx~s~ ~g~%s~s~',
  ['have_deposited'] = 'you have deposited ~y~%sx~s~ ~g~%s~s~',
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
