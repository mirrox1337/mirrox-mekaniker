Locales['fr'] = {
  ...
  ['license_revoked'] = 'votre ~g~%s~s~ a été ~y~révoqué~s~!',
  ['licence_you_revoked'] = 'vous avez révoqué un ~g~%s~s~ qui appartenait à ~y~%s~s~',
  ['no_players_nearby'] = 'aucun joueur à proximité',
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~g~Police~s~',
  -- Vehicle interaction
  ...
  ['search_database_found'] = 'le véhicule est ~y~enregistré~s~ à ~g~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'vous avez confisqué ~y~%sx~s~ ~g~%s~s~ à ~g~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~g~%s~s~ ont été confisqués par ~y~%s~s~',
  ['you_confiscated_account'] = 'vous avez confisqué ~g~$%s~s~ (%s) à ~g~%s~s~',
  ['got_confiscated_account'] = '~g~$%s~s~ (%s) ont été confisqués par ~y~%s~s~',
  ['you_confiscated_weapon'] = 'vous avez confisqué ~g~%s~s~ à ~g~%s~s~ avec ~o~%s~s~ balles',
  ['got_confiscated_weapon'] = 'votre ~g~%s~s~ avec ~o~%s~s~ balles a été confisqué par ~y~%s~s~',
  ...
  ['have_withdrawn'] = 'vous avez retiré ~y~%sx~s~ ~g~%s~s~',
  ['have_deposited'] = 'vous avez déposé ~y~%sx~s~ ~g~%s~s~',
  ['quantity'] = 'quantité',
