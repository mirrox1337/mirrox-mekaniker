Locales['pl'] = {
  ...
  ['license_revoked'] = 'twoja licencja ~g~%s~s~ została ~y~unieważniona~s~!',
  ['licence_you_revoked'] = 'unieważniasz ~g~%s~s~ które należały do ~y~%s~s~',
  ...
  ['search_database_found'] = 'pojazd jest ~y~zarejestrowany~s~ do ~g~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'skonfiskowałeś ~y~%sx~s~ ~g~%s~s~ od ~g~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~g~%s~s~ zostały skonfiskowane przez ~y~%s~s~',
  ['you_confiscated_account'] = 'skonfiskowałeś ~g~%s$~s~ (%s) od ~g~%s~s~',
  ['got_confiscated_account'] = '~g~%s$~s~ (%s) zostały skonfiskowane przez ~y~%s~s~',
  ['you_confiscated_weapon'] = 'skonfiskowałeś ~g~%s~s~ od ~g~%s~s~ z ~o~%s~s~ pociskami',
  ['got_confiscated_weapon'] = 'twój ~g~%s~s~ z ~o~%s~s~ kulami został skonfiskowany przez ~y~%s~s~',
  ...
  ['have_withdrawn'] = 'wyjmujesz z depozytu ~y~%sx~s~ ~g~%s~s~',
  ['have_deposited'] = 'zdeponowano ~y~%sx~s~ ~g~%s~s~',
  ['quantity'] = 'ilość',
  ['inventory'] = 'ekwipunek',
